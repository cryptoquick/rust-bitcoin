...
impl Address {
    ...
    /// Constructs a new pay-to-merkle-root (P2MR / BIP-360) [`Address`] from a merkle root.
    pub fn p2mr(merkle_root: TapNodeHash, hrp: impl Into<KnownHrp>) -> Self {
    ...
    pub fn address_type(&self) -> Option<AddressType> {
        match *self.inner() {
            ...
            AddressInner::Segwit { ref program, hrp: _ } =>
                ...
                } else if program.is_p2mr() {
                    Some(AddressType::P2mr)
